        ...
        {itinerariesData.map((itinerary) => (
          ...
          >
            ...
            <div className="p-5 lg:p-6 flex flex-col grow">
              ...
              {/* Amenities Icons */}
              <div className="flex items-center justify-center gap-4 mb-6 text-secondary">
              ...
              {/* Button */}
              <button className="w-full max-w-[200px] mx-auto border border-gray-300 py-2.5 px-6 rounded text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                VIEW ITINERARY
              </button>
            </div>
          </div>
